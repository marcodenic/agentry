...
// isTier0Agent returns true if the agentName refers to the primary coordinating agent.
func isTier0Agent(agentName string) bool {
	return agentName == "agent_0"
}
